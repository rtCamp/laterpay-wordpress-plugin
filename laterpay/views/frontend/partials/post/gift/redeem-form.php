...
$type = ( ! empty( $laterpay['type'] ) && in_array( $laterpay['type'], $allowed_types, true ) ) ? $laterpay['type'] : '';
...
<div id="lp_js_giftCardWrapper" class="lp_js_giftCodeWrapper lp_js_dataDeferExecution lp_redeem-code__wrapper lp_clearfix">
    ...
    <a href="#" class="lp_js_giftCardRedeemButton lp_redeem-code__button lp_button" data-type="<?php echo esc_attr( $type ); ?>" data-pass-id="<?php echo absint( $pass_id ); ?>">
